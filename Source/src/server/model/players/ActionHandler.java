	...
	public void firstClickObject(int objectType, int obX, int obY) {
		...
		case 2288:
			if (c.getX() == 3004 && c.getY() == 3937)
				Agility.completeWildyPipe(c);
			break;
		case 2311:
			if (c.getX() == 3002 && c.getY() == 3960)
				Agility.skippingStone(c);
			break;
		case 2297:
			if (c.getX() == 3002 && c.getY() == 3945)
				Agility.walkAcross(c, 762, -8, 0, obX, obY, 3);
			break;
		case 2295:
			c.getPA().walkTo(c.absX - obX, c.absY - obY);
			if (c.absX == 2474 && c.absY == 3436) {
				Agility.walkAcross(c, 762, 0, -7, obX, obY, 0);
			}
			break;
		case 2328:
			Agility.walkAcross(c, 740, 0, -4, obX, obY, 4);
			break;
		case 2285:
			Agility.moveTele(c, 2474, 3424, 1, 828, 2);
			break;
		case 2313:
			Agility.moveTele(c, 2473, 3420, 2, 828, 3);
			break;
		case 2312:
			Agility.walkAcross(c, 762, +6, 0, obX, obY, 1);
			break;
		case 2314:
			Agility.moveTele(c, 2485, 3419, 0, 828, 4);
			break;
		case 2286:
			if (c.absY == 3425) {
				Agility.moveTele(c, c.absX, c.absY == 3425 ? c.absY + 2
						: c.absY, 0, 828, 5);
			}
			break;
		case 4058:
		case 154:
			Agility.completePipe(c, 6);
			break;
		case 2294:
			if (c.getY() == 3546) {
				Agility.walkAcrossBarb(c, 762, -10, 0, obX, obY, 0);
			}
			break;
		case 2284:
			Agility.obstacleNetBarb(c, 828, obX, obY, 0);
			break;
		case 2302:
			if (c.getX() == 2536 && c.getY() == 3547)
				Agility.walkAcross(c, 756, -4, 0, obX, obY, 1);
			break;
		case 1948:
			if (c.getY() == 3553) {
				Agility.crumbleWallBarb(c);
			}
			break;
		case 2282:
			if (c.getX() == 2551 && c.getY() == 3554)
				Agility.ropeSwingBarb(c);
			break;
			case 5088:
			Agility.walkAcross(c, 762, +5, 0, obX, obY, 3);
			break;
		case 5090:
			Agility.walkAcross(c, 762, +5, 0, obX, obY, 3);
			break;
		case 5110:
			...
			break;
		case 1317:
		c.getDH().sendDialogues(77, objectType);
		break;
		case 29954:
...
break; 
	...
	public void secondClickObject(int objectType, int obX, int obY) {
		...
		break;
			...
			break;
			case 4874:
				c.getPA().stealFromStall(995, 3000 + Misc.random(5000), 100, 1);
			
			break;
			case 4875:
				c.getPA().stealFromStall(995,4000 + Misc.random(8000), 130, 25);
			
			break;
			case 4876:
				c.getPA().stealFromStall(995, 5000 + Misc.random(8500), 160, 50);

			break;
			case 4877:
				c.getPA().stealFromStall(995,6000 +  Misc.random(9000), 180, 75);

			break;
			case 4878:
				c.getPA().stealFromStall(995, 7000 + Misc.random(10000), 250, 90);
		...
		default:
			...
			if (c.playerRights == 3) {
				c.sendMessage("OBJECT 2 : " + objectType + ", " + obX + ", "
						+ obY + ".");
			}
			break;
		}
	...
	public void secondClickNpc(int npcType) {
		...
		break;
			...
			case 26:
			case 21:
				c.Thieving().stealFromNPC(npcType);
			break;*/
			default:
