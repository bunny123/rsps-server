...
public class PlayerAssistant{
	...
	public int getHPForXP(int exp) {
		int points = 0;
		boolean output = false;

		for(int lvl = 1; lvl <= this.c.maxLevel(); ++lvl) {
			...
			if(exp == this.c.playerXP[3]) {
				lvl += this.c.newArmAmount * (this.getLevelForXP(this.c.playerXP[3]) / 17);
			}
...
public boolean playerNameExists(String name) {
	...
	/*public void setSidebarInterfaces1(Client c) {
		if(c.stageT >= 10) {
			int[] inter = {
				2434,	//Attack
				3917,	//Skill
...
public void refreshSkill(int i) {
		switch (i) {
			...
			break;
			 case 24:
			sendFrame126("" + c.playerLevel[24] + "", 4014);
			sendFrame126("" + getLevelForXP(c.playerXP[24]) + "", 4015);
			sendFrame126("" + c.playerXP[24] + "", 4074);
			sendFrame126("" + getXPForLevel(getLevelForXP(c.playerXP[24]) + 1) + "", 4075);
			break;
			case 7:
			...
			case 21:
			sendFrame126("" + c.playerLevel[24] + "", 4016);
			sendFrame126("" + getLevelForXP(c.playerXP[24]) + "", 4017);
			sendFrame126("" + c.playerXP[24] + "", 4080);
			sendFrame126("" + getXPForLevel(getLevelForXP(c.playerXP[24])+1) + "", 4081);
			break;
		}
	}
