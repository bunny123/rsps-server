...
public abstract class Player {
	...
	int maxLevel() {
		return this.newArmAmount > 0?99 + this.newArmAmount * 20:99;
	}
	...
	public boolean healUni = false, playerStun, stopPlayerPacket;
...
public boolean cannotSummon() {
 ...
 public int curseDefence = 0;
	...
	public long lastPlayerMove,lastPoison,lastPoisonSip,poisonImmune,lastSpear,lastProtItem, dfsDelay, lastVeng,lastYell,teleGrabDelay, protMageDelay, protMeleeDelay, protRangeDelay, lastAction, lastThieve,lastLockPick, alchDelay, specDelay = System.currentTimeMillis(), specDelayy = System.currentTimeMillis(), duelDelay, teleBlockDelay, godSpellDelay, singleCombatDelay, singleCombatDelay2, reduceStat, restoreStatsDelay, logoutDelay, buryDelay, foodDelay, potDelay;
	...
	public int leechEnergyDelay, soulSplitDelay, leechAttackDelay,
                        ...
                        leechSpecialDelay, sapWDelay, sapSDelay, sapRDelay, sapMDelay;
