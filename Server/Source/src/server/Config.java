...
public class Config {
	...
	public static final int ITEM_LIMIT =  20168; // item id limit, different clients have more items like silab which goes past 15000
	...
	public static final short PYRAMID_COURSE_X = 3364, PYRAMID_COURSE_Y = 2827;
