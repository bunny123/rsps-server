        ...
        implements Runnable
{
	...
	public void start(StreamLoader streamLoader, client client1) {
		...
		mapIndices1 = new int[j1+5];
		mapIndices2 = new int[j1+5];
		mapIndices3 = new int[j1+5];
		mapIndices4 = new int[j1+5];
		...
		mapIndices1[j1+1] = 8530;
		mapIndices2[j1+1] = 778;
		mapIndices3[j1+1] = 779;
		mapIndices4[j1+1] = 1;
		
		mapIndices1[j1+2] = 8532;
		mapIndices2[j1+2] = 2058;
		mapIndices3[j1+2] = 2059;
		mapIndices4[j1+2] = 1;
		
		mapIndices1[j1+3] = 8787;
		mapIndices2[j1+3] = 2002;
		mapIndices3[j1+3] = 2003;
		mapIndices4[j1+3] = 1;
		
		mapIndices1[j1+4] = 9044; 
		mapIndices2[j1+4] = 2060;
		mapIndices3[j1+4] = 2061;
		mapIndices4[j1+4] = 1;
	...
	public void handleFailed()
	{
		...
		while(uncompletedCount < 10)
		{
			...
			try {
				...
				if (onDemandData_1.dataType == 0) {
					//logModel(onDemandData_1.ID);
				}
			}
		}
	}
        ...
        for(int j1 = 0; j1 < mapIndices1.length; j1++)
	{
	    ...
	    {
                if(i == 0) {
		 	mapNigga2 = mapIndices2[j1];
				return mapNigga2;
                 } else {
		 	mapNigga3 = mapIndices3[j1];
				return mapNigga3;
		}	
	    }
	}
